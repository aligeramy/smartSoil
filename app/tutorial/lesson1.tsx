...
const lesson1Steps = [
  {
    ...
    description: 'Connect the capacitive soil moisture sensor to your microcontroller.',
    image: require('@/assets/sections/onboarding/background.jpg'), // Replace with actual lesson image
  },
  {
    title: 'Understanding Readings',
    description: 'Learn how to interpret the sensor data and moisture levels.',
    image: require('@/assets/sections/onboarding/background.jpg'), // Replace with actual lesson image
  },
  {
    title: 'Calibration',
    description: 'Calibrate your sensor for accurate readings in different soil types.',
    image: require('@/assets/sections/onboarding/background.jpg'), // Replace with actual lesson image
  },
];
...
export default function Lesson1Screen() {
  ...
  useEffect(() => {
    startLesson(LESSON_ID, lesson1Steps.length);
  }, []);
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.lessonInfoContainer}>
          ...
          <Text style={styles.lessonTitle}>Soil Sensor Basics</Text>
        </View>
      ...
      <View style={styles.contentContainer}>
        {!leaving ? (
          ...
          >
            <Image 
              source={lesson1Steps[currentStep].image}
              style={styles.stepImage}
              resizeMode="contain"
            />
            
            <Text style={styles.stepTitle}>
              {lesson1Steps[currentStep].title}
            </Text>
            
            <Text style={styles.stepDescription}>
              {lesson1Steps[currentStep].description}
            </Text>
          </Animated.View>
        ) : null}
      </View>
      ...
      <View style={styles.footer}>
        <View style={styles.stepCounter}>
          <Text style={styles.stepCounterText}>
            {currentStep + 1}/{lesson1Steps.length}
          </Text>
        </View>
